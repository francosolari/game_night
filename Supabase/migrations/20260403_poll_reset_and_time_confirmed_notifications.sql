-- Poll lifecycle hardening:
-- 1) Host can reset fixed -> poll state and require revote
-- 2) confirm_time_option always reconciles RSVP from votes and emits time_confirmed notifications
