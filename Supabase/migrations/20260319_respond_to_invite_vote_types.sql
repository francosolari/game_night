-- Update respond_to_invite to support tri-state vote types (yes/maybe/no).
-- Adds p_votes jsonb parameter: [{"time_option_id": "uuid", "vote_type": "yes|maybe|no"}]
-- p_selected_time_option_ids is kept for backward compatibility (treated as 'yes' votes).
-- When p_votes is provided (non-empty), it takes precedence over p_selected_time_option_ids.
