...
struct CreateEventGamesStep: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.xl) {
            ...
            UnifiedGameSearchSection(viewModel: viewModel)

            // From Your Library section (when no games selected)
            if viewModel.selectedGames.isEmpty && !viewModel.libraryGames.isEmpty && viewModel.gameSearchQuery.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
